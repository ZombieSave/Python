...
newElementString = input("Введите новый элемент: ")
newElement = int(newElementString)

if newElement <= min(rating):
    rating.append(newElement)
elif newElement >= max(rating):
    rating.insert(0, newElement)
else:
    index = rating.index(newElement)
    rating.insert(index, newElement)
